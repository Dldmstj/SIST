...
public class A01_API_Start {
	public static void main(String[] args) {
		/*
		  ...
		  2. API 도큐먼트
		  	1) api를 쉽게 찾아 활용할 수 있도록 문서화한 것
		  	2) html페이지로 작성되어있어 웹브라우저로 바로 볼 수 있다.
		  # java.lang 패키지
		  	...
		  	1) Object
		  		...
		  		그러므로, Object가 가지고 있는 기본적인 메서드는 재정의하거나 사용할 수 있다.
		  			ex) ArrayList list == ArrayList<Object> list
		  			 	...
		  			 	// ob.getName();	(x), Object에 getName 메서드를 갖고있지 않기 때문에 사용할 수 없다.
		  			 	Person p1 = (Person)ob;		// 타입캐스팅 필요. 하위 클래스에서 추가정의한 메서드는 상위에서 사용 x
		  			 					// 하위 클래스에서 상위 클래스의 기능메서드를 재정의한 경우에는 하위 클래스의 정의 내용으로 사용할 수 있음
		  			 	p1.getName();
		 */
		Person p = new Person();
		...
		// toString()으로 정의된 내용을 출력
		
		System.out.println("hashCode: " + p.hashCode());
		System.out.println("hashCode: " + p2.hashCode());
		System.out.println("hashCode: " + p3.hashCode());
		// 특정한 객체의 고유 코드값으로 생성시마다 다른 코드값을 가지고 있다.
		// 해당 객체의 참조 변수가 같은지 확인할 때, 사용된다.
